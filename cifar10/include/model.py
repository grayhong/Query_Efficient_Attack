...
def model(x_image, y, reuse=False):
    _IMAGE_SIZE = 32
    _IMAGE_CHANNELS = 3
    _NUM_CLASSES = 10
    ...
    with tf.variable_scope('Visualization', reuse):
    ...
    with tf.variable_scope('fully_connected1', reuse=reuse) as scope:
    ...
    with tf.variable_scope('fully_connected2', reuse=reuse) as scope:
    ...
    return softmax_linear, global_step, y_pred_cls, var_list
